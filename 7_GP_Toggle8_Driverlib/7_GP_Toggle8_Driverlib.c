...
// 7_GP_Toggle8_Bitfield.c, FreeRTOS 태스크로 구현한 7_GP_Toggle8_Freertos.c와 함께 세 가지
// 방식을 비교해 보실 수 있습니다.
//
//************************************************************************************************************************************************************************
...
//	9. Idle(Background) Loop
	for(;;)
	{
		...
		DEVICE_DELAY_US(20000U);	// 20msec 지연 (폴링 주기)
	}
}
...
//
// initSwitchGpio - GPIO18~GPIO25를 전부 입력(내부 풀업, 동기 입력)으로 설정
//
void initSwitchGpio(void)
{
